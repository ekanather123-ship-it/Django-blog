...
from django.conf.global_settings import LOGIN_REDIRECT_URL, STATICFILES_DIRS, EMAIL_HOST_PASSWORD
...
SECRET_KEY = 'django-insecure-#*o@t_ngz4pdm=5il(6p6*s$ahv4=+^hh+$w9h&xcd(0^pj=h-'
...
EMAIL_HOST_USER = 'blogit@gmail.com'
